...
// const gemas = document.querySelector('.gemas');
// const contato = document.querySelector('.contato');
// const titulo = contato.querySelector('.titulo');
// const mapa = document.querySelector(".mapa");
// // gemas.appendChild(titulo) // move o título do contato para o final de .gemas
// //contato.insertBefore(gemas, mapa) //insere antes do elemento "mapa"
...
// const animais = document.querySelector('.gemas');
